...
@EnableJpaRepositories(basePackages = "br.com.ribeiraoreefshop.orcamentos.model.repositories")
public class ConfiguracaoDB {
	...
	public DataSource dataSource() throws IllegalStateException,
		...
		dataSource.setJdbcUrl("jdbc:postgresql://localhost:5432/orcamentos");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
		...
		entityManagerFactoryBean
				.setPackagesToScan("br.com.ribeiraoreefshop.orcamentos.model.entity");
		entityManagerFactoryBean
